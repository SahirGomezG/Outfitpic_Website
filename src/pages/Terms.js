                ...
                <section id="terms">
                    <div class="container">
                      <div class="row">
                        ...
                        <p>2.3 You may not share or make the Application available to third parties (unless to the degree allowed by the Apple Terms and Conditions, and with OutfitPic's prior written consent), sell, rent, lend, lease or otherwise redistribute the Application.</p>

                        <p>2.4 You may not reverse engineer, translate, disassemble, integrate, decompile, integrate, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Application, or any part thereof (except with OutfitPic's prior written consent).</p>
                        ...
                        <p>3.1 The Application requires a firmware version greater than 1.0 or higher. Licensor recommends using the latest version of the firmware.</p>
                        ...
                        <p>4.2 OutfitPic and the End-User acknowledge that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the licensed Application.</p>
                        ...
                        <p>6.2 No warranty is provided for the Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of OutfitPic's sphere of influence that affect the executability of the Application.</p>

                        <p>6.3 You are required to inspect the Application immediately after installing it and notify OutfitPic about issues discovered without delay by e-mail provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been mailed within a period of ninety (90) days after discovery.</p>

                        <p>6.4 If we confirm that the Application is defective, OutfitPic reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.</p>
